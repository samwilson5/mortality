files = list.files("E:/SoilWat/dryness/dry_output/historic/",
                      full.names=TRUE)
library(stringr)
...
df = data.frame(site = c('CO','WY','NV1','NV2','UT'),
                ...
                historic_occurrences = c(0,1,0,0,0))
write.csv(df,"E:/SoilWat/historic_visited_simulated_probabilities_UPDATE.csv")
